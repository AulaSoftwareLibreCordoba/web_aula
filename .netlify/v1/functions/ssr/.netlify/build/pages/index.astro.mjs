/* empty css                                 */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, d as renderHead, e as renderComponent, f as renderSlot, b as createAstro } from '../chunks/astro/server_BkUrnYda.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="flex flex-col items-center justify-center pt-32 md:pt-24 lg:pt-28 xl:pt-32 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-[#22235f] via-[#27286b] to-[#0d0d30] bg-center bg-cover"> <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center"> <h1 class="max-w-lg mx-auto font-bold text-4xl md:text-5xl text-white mb-4 leading-tight"> <span id="animatedTitle" class="text-white"></span> <span id="animatedTitle2" class="text-blue-600"></span> <span id="cursor" class="text-white">|</span> </h1> <p class="max-w-md mx-auto text-sm font-normal text-gray-500 mb-6">
Transformamos Ideas en Soluciones Abiertas, Fomentando el Conocimiento y
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" class="bg-[#0d0d43]"> <head><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width=device-width"><link rel="icon" type="image" href="../../public/logo.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderHead()}</head> <body> ${renderComponent($$result, "Header", $$Header, {})} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Hero", $$Hero, {})} </body></html>`;
